...
export const HoursNavigation = observer(({ user, setEditOpen }: Props) => {
  ...
  return (
    <div className="pt-5 px-5">
      <table className="w-11/12 flex flex-row flex-no-wrap rounded-lg overflow-hidden my-5 mx-5">
        ...
        <tbody className="flex-1 lg:flex-none">
          <tr className="flex flex-col flex-no wrap lg:table-row mb-2 lg:mb-0">
            ...
            {DAYS_IN_WEEK.map((day) => {
              ...
              return (
                <td className="p-3 2xl:truncate" key={day.label}>
                      ...
                      if (shift.start_time !== null) {
                        return (
                          <span
                            ...
                            className="rounded-md text-center bg-white lg:px-3 py-1 lg:py-2"
                          >
